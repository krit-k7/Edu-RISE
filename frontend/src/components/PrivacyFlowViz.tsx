...
import { LockKeyhole, Cpu, Link as LinkIcon, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="card privacy-viz-card">
      ...
      <div className="privacy-notice">
        <LockKeyhole size={15} className="inline-icon" />
        <span><strong style={{ color: 'var(--text-primary)' }}>Your actual GPA and income are never sent to the network.</strong> The Midnight blockchain only records a cryptographic proof that you satisfy the eligibility threshold — nothing more.</span>
      </div>
    </div>
  );
}
